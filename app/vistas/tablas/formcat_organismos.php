...
<div class="card card-body bg-light mt-5">
  ...
  <?php foreach($datos ['usuarios'] as $usuario):?>
    <tr>
      ...
      <td><?php echo $usuario->RAZON_SOCIAL_ORGANISMO;?></td>
      <td><?php echo $usuario->RFC_ORGANISMO;?></td>
      <td><?php echo $usuario->CURP_ORGANISMO;?></td>
      <td>
											<span class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editAdministrativa" onclick="agregaFrmActualizar('<?php echo  $usuario->ID_COMP?>','<?php echo $usuario->RAZON_SOCIAL_ORGANISMO?>','<?php echo $usuario->RFC_ORGANISMO?>','<?php echo $usuario->CURP_ORGANISMO?>')">
