...
$this->db->query('select cf.DES_CON_CORTA,ID_CONCEPTO_DETFAC,DESC_CONCEPTO_DETFAC,IMP_VENCIDO_DETFAC,IMP_MES_DETFAC,IMP_TOT_DESFAC from dat_fac_detalle df inner join cat_concepto_facturacion cf on df.ID_CONCEPTO_DETFAC=cf.ID_CON_FACTURACION WHERE no_recibo_detfac= "' . $id . ' "');
...
$pdf->Cell(17, 10, 'Concepto', 0);
$pdf->Cell(10, 10, 'Vencido',0,0,'R');
$pdf->Cell(15, 10, 'Actual',0,0,'R');
$pdf->Cell(18, 10, 'Total',0,0,'R');
$pdf->Ln(8);
$pdf->Cell(60,0,'','T');
$pdf->Ln(1);
...
$pdf->Cell(12, -5,$res_fac[$numero]->DES_CON_CORTA,0,0,'R');
$pdf->Cell(15, -5,"$".$res_fac[$numero]->IMP_VENCIDO_DETFAC,0,0,'R');
$pdf->Cell(15, -5,"$".$res_fac[$numero]->IMP_MES_DETFAC,0,0,'R');
$pdf->Cell(0, -5,"$".$res_fac[$numero]->IMP_TOT_DESFAC,0,0,'R');
$pdf->Ln(1);
...
$pdf->Ln(7);
$pdf->SetFont('Helvetica', 'B', 7);
$pdf->Cell(25, 10, 'Concepto', 0);
$pdf->Cell(2, 10, 'Vencido',0,0,'R');
$pdf->Cell(15, 10, 'Actual',0,0,'R');
...
$pdf->Cell(28, -5,"$".$vencido,0,0,'R');
$pdf->Cell(15, -5,"$".$mes,0,0,'R');
$pdf->Cell(18, -5,"$".$saldo_tot,0,0,'R');
$pdf->Ln(0);
