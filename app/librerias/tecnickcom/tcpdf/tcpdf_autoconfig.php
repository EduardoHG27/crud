...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'log.jpg')) {
		$tcpdf_header_logo = 'log.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Comisión de Agua');
}
if (!defined('PDF_HEADER_TITLE_1')) {
	define ('PDF_HEADER_TITLE_1', 'Comisión de Agua de Delicias ,Chihuahua');
}


if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Sistema Comercial");
}
